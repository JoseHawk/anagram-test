...
@AllArgsConstructor
public class WhenTheUserChecksForSimpleAnagramComparisonRemovingSpecialCharacters {
    ...
    public void the_user_checks_for_simple_anagram_comparison_removing_special_characters() {
        ComparisonRequest comparisonRequest = new ComparisonRequest("#the Morsé Codé", "here come dots    ", true);
